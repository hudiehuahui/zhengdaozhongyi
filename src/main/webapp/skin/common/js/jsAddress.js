...
{name:'台湾', cityList:[
{name:'台北市', areaList:['中正区','万华区','大同区','中山区','松山区','大安区','信义区','内湖区','南港区','士林区','北投区','文山区']},     
...
{name:'台中市', areaList:['中区','东区','南区','西区','北区','北屯区','西屯区','南屯区','北屯区','丰原区','大里区','太平区','东势区','大甲区','清水区','沙鹿区','梧栖区','后里区','神冈区','潭子区','大雅区','新小区','石冈区','外埔区','大安区','乌日区','大肚区','龙井区','雾峰区','和平区']},     
...
{name:'高雄市', areaList:['楠梓区','左营区','鼓山区','三民区','盐埕区','前金区','新兴区苓雅区','前镇区','旗津区','小港区','小港区','凤山区','大寮区','鸟松区','林园区','仁武区','大树区','大社区','冈山区','路竹区','桥头区','梓官区','弥陀区','永安区','燕巢区','阿莲区','茄萣区','湖内区','旗山区','美浓区','内门区','杉林区','甲仙区','六龟区','茂林区桃源区','那玛夏区']},   
{name:'基隆市', areaList:['东　区','西　区']}    
]},
{name:'香港', cityList:[
