...
public class HttpClientCommon {
	...
	public String responseBody(String url, String data) throws Exception {
		...
		//
		// httpClient.getHostConfiguration().setProxy(ConfigConstants.PROXYHOST,
		// ConfigConstants.PROXYPORT) ;
		//
		// }
	...
	public String responseBody(String url, String[][] params) {
		...
		for (int i = 0; i < name.length; i++) {
			NameValuePair xmlData = new NameValuePair(params[i][0],
					params[i][1]);
			name[i] = xmlData;
		}
	...
	public String responsePostBody(String url, String data) throws Exception {
		...
		postMethod
				.setRequestEntity(new StringRequestEntity(data, null, "utf-8"));
		try {
	...
	public static String post(String url, String data, String contentType)
		...
		managerParams.setSoTimeout(200000);
	 ...
	 * @return
	 */
	public static String post(String url, NameValuePair[] data, Header[] header)
			throws Exception {
