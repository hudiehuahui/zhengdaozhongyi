...
public class ImageUtil {
    ...
    public static void main(String[] args) throws Exception{
        String srcImgPath = "D:/identityCard.png";//源图片路径
        String iconPath = "D:/iconPath.png";//水印图片路径
        String targerPath = "D:/Territory2.png";//目标图片路径
        ...
        // 给图片添加水印
        ImageUtil.waterMarkImageByIcon(iconPath, srcImgPath, targerPath, 0, (srcImg.getWidth(null)-iconImg.getWidth(null))/2,(srcImg.getHeight(null)-iconImg.getHeight(null))/2
, 0.7f);
        // 给图片添加水印,水印旋转-45
