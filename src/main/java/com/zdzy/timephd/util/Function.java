...
import com.zdzy.timephd.statuscode.AccountStatusEnum;
import com.zdzy.timephd.statuscode.AdminRoleStatusEnum;
...
public class Function {
	...
	public static String getEnumName(String type, String statusName) {
		...
		case "AccountStatusEnum":
			result = AccountStatusEnum.getStatusName(statusName);
			break;
		default:
			break;
		}
	...
	public static String getEnumValue(String type, String statusName) {
		...
		case "AdminRoleStatusEnum":
			...
			break;
		case "AccountStatusEnum":
			result = AccountStatusEnum.getStatusValue(statusName).toString();
			break;
		default:
			break;
		}
